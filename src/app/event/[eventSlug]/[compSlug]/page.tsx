...
const CompInfo = async ({ params: { compSlug } }: pageProps) => {
  ...
  return (
    <main>
      <section className="flex overflow-y-hidden min-h-screen max-w-[90vw] mx-auto">
        <section className="flex-1 mx-5 md:ml-12 pb-12 scrollbar-hide overflow-y-scroll">
      ...
      <section>
        <h2 className="font-bold text-4xl text-primary mb-10 mt-14 underline text-center">
          Results
        </h2>
        {/* Results component */}
